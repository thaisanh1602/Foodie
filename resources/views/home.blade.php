...
<head>
  ...
  <title>Trang chủ — Mẫu đơn giản</title>
...
<section class="py-4">
  <div class="container">
    <div class="row text-center">
      <div class="col-4"> <h6>Nhanh</h6><p class="small text-muted">Tốc độ tải tốt</p></div>
      <div class="col-4"> <h6>Đẹp</h6><p class="small text-muted">Thiết kế tối giản</p></div>
      <div class="col-4"> <h6>Dễ dùng</h6><p class="small text-muted">Tùy chỉnh nhanh</p></div>
    </div>
  </div>
</section>
